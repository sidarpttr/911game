...
public class VehicleCamera : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        float minDistance = 7.0f; // Set your desired minimum distance
        float maxDistance = 8.5f; // Set your desired maximum distance
        float speedMultiplier = 0.5f; // You can tweak this multiplier
        float speedThreshold = 75.0f; // Set your desired speed threshold

        float tDistance = Mathf.Lerp(minDistance, maxDistance, Mathf.Clamp01((carScript.speed - speedThreshold) * speedMultiplier));
        distance = Mathf.Lerp(distance, tDistance, Time.deltaTime);
